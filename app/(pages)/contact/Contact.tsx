...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen text-white bg-[#050B11] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-125 h-125 bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="mx-auto max-w-6xl px-4 py-12 lg:px-8 pt-32 lg:pt-36 relative z-10"
      >
        {/* HEADER SECTION */}
